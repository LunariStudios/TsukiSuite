    ...
    public class Deque<T> : IList<T> {
        ...
        public int Capacity {
            ...
            set {
                ...
                var powOfTwo = Utility.ClosestPowerOfTwoGreaterThan(value);
        ...
        private int ToBufferIndex(int index) {
            var bufferIndex = (index + startOffset) & capacityClosestPowerOfTwoMinusOne;
            return bufferIndex;
        }
        ...
        private static void CheckArgumentsOutOfRange(
            ...
            if (offset < 0) {
                throw new ArgumentOutOfRangeException(
                    nameof(offset), "Invalid offset " + offset);
            }
        ...
        public void InsertRange(int index, IEnumerable<T> collection) {
            var count = Utility.Count(collection);
        ...
        public IEnumerator<T> GetEnumerator() {
            ...
            if (startOffset + Count > Capacity) {
                for (var i = startOffset; i < Capacity; i++) {
                ...
                var endIndex = startOffset + Count;
                for (var i = startOffset; i < endIndex; i++) {
                    yield return buffer[i];
                }
            }
        }
        ...
        public void CopyTo(T[] array, int arrayIndex) {
            ...
            if (0 != startOffset
                ...
                var lengthFromStart = Capacity - startOffset;
